...
class Model():
    ...
    def predict_LSTM(self, data_x, normalized=True, de_normalized=True):
        ...
        # Load the Net_model
        #print(current_path + "/models/LSTM_model_"+str(self.stride)+".pth")
        net = torch.load(current_path + "/models/LSTM_model_"+str(self.stride)+".pth")
    ...
    def predict_Net(self, data_x, normalized=True,de_normalized=True):
        ...
        # Load the Net_model
        #print(current_path + "/models/Net_model_"+str(self.stride)+".pth")
        net = torch.load(current_path + "/models/Net_model_"+str(self.stride)+".pth")
    ...
    def test_future_LSTM(self, data_files_dic="./data2/", normalized=False, percent=0.9, future=10):
